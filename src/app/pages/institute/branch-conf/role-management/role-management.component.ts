...
selectedSize:NbComponentSize = 'medium'
  constructor(private fb:FormBuilder, private roleService: RoleAssignService, private active: ActivatedRoute,
...
varifyOtp(){
  ...
  this.roleService.verifyOtp(param).subscribe(res => {console.log(res); this.valid('top-right', 'success');}, 
  error => {
    console.log(error);
