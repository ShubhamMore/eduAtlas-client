...
export class AddStudentsComponent implements OnInit {
  ...
  student= 
    ...
    constructor(private fb: FormBuilder, private api: ApiService,private router: Router, private active: ActivatedRoute, private toasterService:NbToastrService) { }
    ...
    this.getDiscounts(this.routerId);
      ...
      studentEmail: ['', Validators.compose([
