...
export class ECommerceComponent {
  ...
  myInstitute = {
    institute: {
      basicInfo: { name: '', logo: null, instituteContact: '' },
  ...
  ngOnInit() {
    ...
    MENU_ITEMS[4].children[0].link =
      '/pages/institute/branch-config/manage-course/' + this.routerId;
    MENU_ITEMS[4].children[1].link = '/pages/institute/branch-config/manage-batch/' + this.routerId;
    MENU_ITEMS[4].children[2].link =
      '/pages/institute/branch-config/manage-discount/' + this.routerId;
